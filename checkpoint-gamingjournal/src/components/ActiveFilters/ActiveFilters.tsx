...
export default function ActiveFilters({
    ...
    const activeFilters = selectedTypes.length > 0 || selectedGenres.length > 0 || selectedModes.length > 0 || selectedThemes.length > 0 || selectedPlatforms.length > 0;
    const numberOfActiveFilters = selectedGenres.length + selectedTypes.length + selectedModes.length + selectedThemes.length + selectedPlatforms.length;
