...
export default function AddToLibraryModal({
  ...
  const gameStatuses = [
    ...
    },
    {
        ...
        icon: <Star size={20} color='rgb(231, 210, 20)' fill="rgb(231, 210, 20)"/>,
        color: 'gold'
    },
    {
        value: 'Backlog',
  ...
  return(
    ...
    >
      ...
      <Button fullWidth size='md' radius='md' mt='md' leftSection={<SaveAll size={20} />} onClick={handleAddToLibrary}>
        Add to Library
      </Button>
    </Modal>
  )
