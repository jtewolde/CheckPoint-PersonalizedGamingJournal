...
export default function PasswordPage(){
    ...
    return(
        <div className={classes.passwordContainer} >
            ...
            <PasswordInput className={classes.passwordInput} label="Current Password" placeholder="Current password" leftSection={<Lock size={20} />} mt="md" size="md" value={currentPassword} onChange={(e) => setCurrentPassword(e.currentTarget.value)} error={passwordError}/>

            <PasswordInput className={classes.passwordInput} label="Password" placeholder="Your password" leftSection={<Lock size={20} />} mt="md" size="md" value={newPassword} onChange={(e) => setNewPassword(e.currentTarget.value)} error={passwordError}/>
