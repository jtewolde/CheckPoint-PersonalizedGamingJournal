...
export default function TrendingPage() {
  ...
  const [sortOption, setSortOption] = useState<
    "first_release_date" | "total_rating" | "alphabetical" | ""
  >("first_release_date"); // State to sort search results from release date/total_rating
    ...
    const fetchTrendingGames = async () => {
      try {
        ...
        const res = await fetch(
          `/api/igdb/trending-games?${params.toString()}`,
        );
        ...
        <div className={classes.headerSection}>
          <div className={classes.titleDescriptionSection}>
            ...
            <Text className={classes.description}>
              Explore the hottest games capturing attention today. From breakout
              hits to rising favorites, see what's trending across the gaming
              world.
            </Text>
          </div>
