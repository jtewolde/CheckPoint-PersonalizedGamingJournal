...
export default function MostAnticipated() {
  ...
  const [sortOption, setSortOption] = useState<
    ...
    | "total_rating"
    | "alphabetical"
    | "first_release_date_oldest"
    | "hypes"
    | "hypes_reverse"
    | ""
  >("hypes"); // State to sort search results from release date/total_rating
    ...
    const fetchMostAnticipated = async () => {
      try {
        ...
        const res = await fetch(
          `/api/igdb/most-anticipated?${params.toString()}`,
        );
        ...
        <div className={classes.headerSection}>
          <div className={classes.titleDescriptionSection}>
            ...
            <Text className={classes.description}>
              Browse the highest-hyped releases and never miss the next big
              launch.
            </Text>
          </div>
