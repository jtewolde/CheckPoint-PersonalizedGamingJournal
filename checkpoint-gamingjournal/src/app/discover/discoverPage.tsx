    ...
    <div className={classes.wrapper}>
      <div className={classes.mainContent}>
        <Stack gap={10} align="flex-start">
          <Title className={classes.headerTitle}>Discover Games</Title>

          <Text className={classes.descriptionText}>
            Explore trending releases, top-rated classics, and hidden gems.{" "}
            <br />
        ...
        <Stack gap="xl" align="center">
          <div className={classes.trendingGames}>
            <div className={classes.trendingSection}>
              <div className={classes.titleLogo}>
                <ThemeIcon
                  variant="gradient"
                  gradient={{ from: "#c21500", to: "#ffc500", deg: 90 }}
                  size={40}
                >
              ...
              <Tooltip
                label="View More Trending Games"
                position="top"
                events={{ hover: true, focus: true, touch: true }}
              >
                <a className={classes.viewMoreIcon} href="/search/trending">
                  {" "}
          ...
          <div className={classes.popularGames}>
            <div className={classes.popularSection}>
              ...
              <Tooltip
                label="View More Popular Games"
                position="top"
                events={{ hover: true, focus: true, touch: true }}
              >
                <a className={classes.viewMoreIcon} href="/search/popular">
                  <CircleArrowRight size={35} />
                </a>
              </Tooltip>
            </div>
          ...
          <div className={classes.upcomingGames}>
            <div className={classes.upcomingSection}>
              <div className={classes.titleLogo}>
                <ThemeIcon
                  variant="gradient"
                  gradient={{ from: "#05ca0b", to: "#18c973", deg: 90 }}
                  size={40}
                >
              ...
              <Tooltip
                label="View More Upcoming Games"
                position="top"
                events={{ hover: true, focus: true, touch: true }}
              >
                <a className={classes.viewMoreIcon} href="/search/upcoming">
                  {" "}
                  <CircleArrowRight size={35} />{" "}
                </a>
              </Tooltip>
          ...
          <div className={classes.anticipatedGames}>
            <div className={classes.anticipatedSection}>
              <div className={classes.titleLogo}>
                <ThemeIcon
                  variant="gradient"
                  gradient={{ from: "#2c1ef7", to: "#5b22e1", deg: 20 }}
                  size={40}
                >
              ...
              <Tooltip
                label="View More Anticipated Games"
                position="top"
                events={{ hover: true, focus: true, touch: true }}
              >
                <a
