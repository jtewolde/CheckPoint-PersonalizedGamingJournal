...
export async function GET(req: NextRequest) {
  try {
    ...
    if (!game || game.length === 0) {
      return NextResponse.json(
        { message: "Game not found from IGDB." },
        { status: 404 },
      );
    }
