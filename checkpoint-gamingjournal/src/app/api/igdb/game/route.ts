...
export async function GET(req: NextRequest){
    try{
        ...
        const igdbRes = await fetch(IGDB_URL, {
            ...
            body: `fields name, summary, genres.name, platforms.name, involved_companies.company.name, cover.url, version_title, screenshots.url, first_release_date, collections ; where id = ${id};`,
        });
